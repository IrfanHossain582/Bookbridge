...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `book`(Book_Id, Book_Title, category, Publication_Year, Book_details, Book_Price, Author_Id, Book_Image) VALUES('$book_id', '$name', '$category', '$book_date', '$details', '$price', '$author_id', '$image')");
...
<body>
   ...
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="text" name="category" class="box" placeholder="enter book category" required> <!-- New field for category -->
