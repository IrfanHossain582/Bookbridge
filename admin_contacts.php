...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `messages` WHERE message_id  = '$delete_id'") or die('query failed');
...
<section class="messages">
   ...
   <div class="box">
      ...
      <p> name : <span><?php echo $fetch_message['customer_name']; ?></span> </p>
      
      <p> email : <span><?php echo $fetch_message['customer_email']; ?></span> </p>
      <p> number : <span><?php echo $fetch_message['customer_num']; ?></span> </p>
